...
public class DetectEnvironment {
    public static <ID> Detection<ID, Temperature> detectRoomTemperature(Sensor<ID, Temperature> sensor) {
        return sensor.detect();
    }

    public static <ID> Detection<ID, Brightness> detectRoomBrightness(Sensor<ID, Brightness> sensor) {
        return sensor.detect();
    }

    public static <ID> Detection<ID, Humidity> detectRoomHumidity(Sensor<ID, Humidity> sensor) {
        return sensor.detect();
    }
}
